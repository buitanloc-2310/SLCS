...
const checks=[
 ...
 ['Pages realtime fallback schema',read('migrations/0007_live_runtime.sql').includes('live_runtime_signals')],
 ['Pages realtime fallback API',api.includes('const liveRuntime=path.match')&&api.includes('live_runtime_signals')],
 ['websocket error visible',!app.includes('ws.onerror=()=>{}')&&app.includes('startHttpRealtime')&&app.includes('Đang khôi phục')],
